...
Tags = ["server", "linux"]
date = "2022-06-06T22:10:14+03:00"
title = "Бесшумный NAS для дома и собственное файловое облако на Linux. Часть 2"
Banner = "/img/nas2-qnap.jpg"
draft=false
+++

Вот уже три года я использую в своём цифровом быту QNAP в качестве файлохранилки. Про выбор железки и первоначальную установку я писал в [первой части](https://4te.me/post/silent-home-nas) этой статьи. За это время в моем сетапе произошли изменения, и здесь поделюсь своим опытом за прошедшее время. Теперь из названия статьи можно убрать слово "файловое".
...
Дальше я поставил у себя на десктопе клиент Nextcloud и попробовал загрузить свои 25к файлов. Клиент кряхтел и пыхтил, но таки за ночь это осилил. А теперь, когда вся масса файлов загружена, добавлять по несколько десятков новых никакой разницы с Seafile не ощущается.
