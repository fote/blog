...
Я уже несколько лет использую Nextcloud в качестве основного места хранения фотографий. И все эти годы страдал от ооочень медленной загрузки фото в веб-интерфейсе и мобильном приложении. На новогодних каникулах попробовал найти решение этой проблемы и, когда нашел его, удивился почему не сделал это с самого начала. Все оказалось очень просто.
...
Я установил плагин из веб-интерфейса, и, перед запуском процедуры генерации, обновил Nextcloud до версии 28.0.1. По субъективным ощущениям последняя версия работает шустрее.
